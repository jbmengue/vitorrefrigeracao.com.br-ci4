...
class TestResponse
{
  ...
  public function assertNotRedirect(): void
  {
    Assert::assertFalse(
      $this->isRedirect(),
      "Response is an unexpected redirect or instance of RedirectResponse.",
    );
  }
  ...
  public function assertSessionHas(string $key, $value = null): void
  {
    ...
    if (is_scalar($value)) {
      Assert::assertSame(
        $value,
        $_SESSION[$key],
        "The value of key '{$key}' ({$value}) does not match expected value.",
      );
    ...
    Assert::assertSame(
      $value,
      $_SESSION[$key],
      "The value of key '{$key}' does not match expected value.",
    );
  }
  ...
  public function assertSessionMissing(string $key): void
  {
    Assert::assertArrayNotHasKey(
      $key,
      $_SESSION,
      "Key '{$key}' should not be present in \$_SESSION.",
    );
  }
  ...
  {
    Assert::assertTrue(
      $this->response->hasHeader($key),
      "Header '{$key}' is not a valid Response header.",
    );
    ...
    if ($value !== null) {
      Assert::assertSame(
        ...
        "The value of '{$key}' header ({$this->response->getHeaderLine(
          $key,
  ...
  public function assertHeaderMissing(string $key): void
  {
    Assert::assertFalse(
      $this->response->hasHeader($key),
      "Header '{$key}' should not be in the Response headers.",
    );
  }
  ...
  {
    Assert::assertTrue(
      $this->response->hasCookie($key, $value, $prefix),
      "Cookie named '{$key}' is not found.",
    );
  }
  ...
  {
    Assert::assertFalse(
      $this->response->hasCookie($key),
      "Cookie named '{$key}' should not be set.",
    );
  }
  ...
  public function assertJSONFragment(array $fragment, bool $strict = false): void
  {
    ...
    Assert::assertThat(
      $patched,
      new IsEqual($json),
      "Response does not contain a matching JSON fragment.",
    );
  }
  ...
  public function assertJSONExact($test): void
  {
    ...
    Assert::assertJsonStringEqualsJsonString(
      $test,
      $json,
      "Response does not contain matching JSON.",
    );
  }
