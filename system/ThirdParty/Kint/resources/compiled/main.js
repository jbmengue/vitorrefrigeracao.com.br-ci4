...
(() => {
    ...
    static #s(t, e) {
      ...
      for (let c of r.children)
        c.tagName === "DL"
          ? n.#s(c, e)
          : c.tagName === "UL" &&
            (c.classList.contains("kint-tabs")
              ? (o = c.children)
              : c.classList.contains("kint-tab-contents") && (l = c.children));
      if (!(!o || o.length !== l?.length))
        for (let c = o.length; c--; ) {
          ...
          if (
            (O.textContent.toUpperCase().includes(e) && ((k = !0), (F = !0)),
            k && o[c].classList.add("kint-search-match"),
            F)
          )
    ...
    static sort(t, e) {
      ...
      ([...r.rows]
        .sort(function (o, l) {
          ...
          return (
            !isNaN(o) && !isNaN(l)
              ? ((o = parseFloat(o)), (l = parseFloat(l)), (c = o - l))
              : isNaN(o) && !isNaN(l)
                ? (c = 1)
                : isNaN(l) && !isNaN(o)
                  ? (c = -1)
  ...
  var a = class n {
      ...
      #i() {
        ...
        if (
          (d(this.#t) || (this.#t = t.querySelector("style.kint-rich-style")),
          this.#t && m(this.#t),
          t.querySelector(".kint-rich.kint-file"))
        ) {
          this.setupFolder(t);
      ...
      get folder() {
        return (
          d(this.#s) || (this.#s = this.#e.window.document.querySelector(".kint-rich.kint-folder")),
          this.#s && m(this.#s),
          this.#s
        );
      }
      ...
      static switchTab(t) {
        ...
        for (let r = i.length; r--; )
          r === s
            ? (i[r].classList.add("kint-show"), n.#n(i[r], !0))
    ...
    b = class {
      ...
      #a(t) {
        ...
        let s = e.closest("dt");
        if (e.tagName === "NAV")
          e.parentNode.tagName === "FOOTER"
            ? (this.#t.setCursor(e), e.parentNode.classList.toggle("kint-show"))
            : s?.classList.contains("kint-parent") &&
              (a.toggle(s),
          ...
          e.classList.contains("kint-search") ||
            (e.tagName === "PRE" && t.detail === 3
              ? f(e)
              : e.closest(".kint-source") && t.detail === 3
                ? f(e.closest(".kint-source"))
                : e.classList.contains("access-path")
                  ? f(e)
                  : e.tagName !== "A" &&
                    s?.classList.contains("kint-parent") &&
                    (a.toggle(s),
    ...
    q = class {
      ...
      #c(t) {
        ...
        if ([P, R, D, H, K].includes(t.keyCode)) {
          (t.keyCode === P
            ? this.#o(t.shiftKey ? -1 : 1)
            : t.keyCode === R || t.keyCode === D
              ? this.#o(-1)
              : (t.keyCode === H || t.keyCode === K) && this.#o(1),
            this.scrollToFocus());
          return;
        }
        if (e.tagName === "LI" && [L, T, C, p, N, S].includes(t.keyCode)) {
          (t.keyCode === L || t.keyCode === T
            ? (a.switchTab(e), this.onTreeChanged())
            : t.keyCode === C || t.keyCode === p
              ? this.#o(1)
              : (t.keyCode === N || t.keyCode === S) && this.#o(-1),
            this.scrollToFocus());
          return;
        }
        if (e.parentNode.tagName === "FOOTER" && e.closest(".kint-rich")) {
          if (t.keyCode === L || t.keyCode === T) e.parentNode.classList.toggle("kint-show");
            ...
            t.keyCode === A &&
            !this.#i.isFolderOpen() &&
            e.matches(".kint-rich > footer > nav")
          ) {
            let i = e
              .closest(".kint-rich")
              .querySelector(".kint-parent > nav, .kint-rich > footer > nav");
        ...
        if (s) {
          ...
          if (t.keyCode === A) {
            !this.#i.isFolderOpen() &&
              s.matches(".kint-rich:not(.kint-folder) > dl > .kint-parent") &&
  ...
  var w = class {
    ...
    #t() {
      ...
      for (let s of e) {
        ...
        if (
          ((s.querySelector(".kint-microtime-avg").textContent = o.avg),
          !(r === o.min && r === o.max))
        )
  ...
  var U = Symbol(),
    h = class n {
      ...
      runOnLoad(t) {
        ...
        else this.#t.addEventListener("load", t);
      }
      runOnInit(t) {
        this.#s.push(t);
      }
      #n() {
        this.#t.document.currentScript &&
          (this.#i.add(E(window.document.currentScript)), window.document.currentScript.remove());
      }
      #o() {
