...
return [
  "invalidExpiresTime" =>
    'Invalid "{0}" type for "Expires" attribute. Expected: string, integer, DateTimeInterface object.',
  ...
  "invalidHostPrefix" =>
    'Using the "__Host-" prefix must be set with the "Secure" flag, must not have a "Domain" attribute, and the "Path" is set to "/".',
  "invalidSameSite" => "The SameSite value must be None, Lax, Strict or a blank string, {0} given.",
  "invalidSameSiteNone" =>
    'Using the "SameSite=None" attribute requires setting the "Secure" attribute.',
  "invalidCookieInstance" =>
    '"{0}" class expected cookies array to be instances of "{1}" but got "{2}" at index {3}.',
  "unknownCookieInstance" =>
    'Cookie object with name "{0}" and prefix "{1}" was not found in the collection.',
];
