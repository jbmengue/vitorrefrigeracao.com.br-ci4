...
class TableName
{
  ...
  {
    return new self($dbPrefix . $table, $table, "", "", $alias);
  }
   ...
   * @param string $alias       Alias name
   */
  public static function fromActualName(
    string $dbPrefix,
    string $actualTable,
    string $alias = "",
  ): self {
    ...
    return new self($actualTable, $logicalTable, "", $alias);
  }
  ...
  public static function fromFullName(
    ...
    return new self($dbPrefix . $table, $table, $schema, $database, $alias);
  }
