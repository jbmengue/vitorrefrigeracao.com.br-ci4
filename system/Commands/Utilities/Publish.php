...
class Publish extends BaseCommand
{
  ...
  protected $options = [
    "--namespace" =>
      "The namespace from which to search for files to publish. By default, all namespaces are analysed.",
  ];
  ...
  public function run(array $params)
  {
    ...
    foreach ($publishers as $publisher) {
      if ($publisher->publish()) {
        ...
        CLI::error(
          lang("Publisher.publishFailure", [$publisher::class, $publisher->getDestination()]),
          "light_gray",
          "red",
        );
