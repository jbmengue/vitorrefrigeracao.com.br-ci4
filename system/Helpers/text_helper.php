...
if (!function_exists("highlight_phrase")) {
  ...
  function highlight_phrase(
    ...
    return $str !== "" && $phrase !== ""
      ? preg_replace("/(" . preg_quote($phrase, "/") . ")/i", $tagOpen . '\\1' . $tagClose, $str)
      : $str;
  }
}
...
if (!function_exists("increment_string")) {
  ...
  function increment_string(string $str, string $separator = "_", int $first = 1): string
  {
    ...
    return isset($match[2])
      ? $match[1] . $separator . ((int) $match[2] + 1)
      : $str . $separator . $first;
  }
}
...
if (!function_exists("excerpt")) {
  ...
  function excerpt(
    ...
    return str_replace(
      "  ",
      " ",
      $ellPre . $firstPartOutput . $phrase . $endPartOutput . $ellipsis,
    );
  }
}
