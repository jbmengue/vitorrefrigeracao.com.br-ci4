...
trait GeneratorTrait
{
  ...
  private function normalizeInputClassName(): string
  {
    ...
    if ($class === null && $this->hasClassName) {
      $nameField =
        $this->classNameLang !== "" ? $this->classNameLang : "CLI.generator.className.default";
    ...
    return ltrim(
      implode("\\", array_map(pascalize(...), explode("\\", str_replace("/", "\\", trim($class))))),
      "\\/",
    );
  }
  ...
  protected function getNamespace(): string
  {
    return $this->namespace ??
      trim(str_replace("/", "\\", $this->getOption("namespace") ?? APP_NAMESPACE), "\\");
  }
