...
class MemcachedHandler extends BaseHandler
{
  ...
  public function initialize()
  {
    try {
      if (class_exists(Memcached::class)) {
        ...
        if (
          !is_array($stats) ||
          !isset($stats[$this->config["host"] . ":" . $this->config["port"]])
        ) {
  ...
  public function deleteMatching(string $pattern)
  {
    throw new BadMethodCallException(
      "The deleteMatching method is not implemented for Memcached. You must select File, Redis or Predis handlers to use it.",
    );
  }
