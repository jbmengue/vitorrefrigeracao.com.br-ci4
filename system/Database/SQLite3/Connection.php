...
class Connection extends BaseConnection
{
  ...
  {
    $sql =
      "SELECT 'PRIMARY' as indexname, l.name as fieldname, 'PRIMARY' as indextype
      ...
      ") as l
                ...
                LEFT JOIN pragma_table_info(" .
      $this->escape(strtolower($table)) .
      ") ti ON ti.name = ii.name
                WHERE sqlite_master.type='index' AND sqlite_master.tbl_name = " .
      $this->escape(strtolower($table)) .
      " COLLATE NOCASE";
