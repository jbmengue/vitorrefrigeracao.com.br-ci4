...
return [
  ...
  "alpha_dash" =>
    "O campo {field} pode conter apenas caracteres alfa-numéricos, sublinhados, e traços.",
  "alpha_numeric" => "O campo {field} pode conter apenas caracteres alfa-numéricos.",
  "alpha_numeric_punct" =>
    'O campo {field} pode conter apenas caracteres alfa-numéricos, espaços, e  ~ ! # $ % & * - _ + = | : . caracteres.',
  "alpha_numeric_space" =>
    "O campo {field} pode conter apenas caracteres alfa-numéricos e espaços.",
