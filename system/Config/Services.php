...
class Services extends BaseService
{
  ...
  public static function curlrequest(
    ...
    return new CURLRequest($config, new URI($options["baseURI"] ?? null), $response, $options);
  }
  ...
  public static function image(
    ...
    $handler =
      $handler !== null && $handler !== "" && $handler !== "0" ? $handler : $config->defaultHandler;
  ...
  public static function parser(
    ...
    $viewPath =
      $viewPath !== null && $viewPath !== "" && $viewPath !== "0"
        ? $viewPath
  ...
  public static function incomingrequest(?App $config = null, bool $getShared = true)
  {
    ...
    return new IncomingRequest($config, AppServices::get("uri"), "php://input", new UserAgent());
  }
  ...
  public static function session(?SessionConfig $config = null, bool $getShared = true)
  {
    ...
    if (!class_exists($driverName) || !is_a($driverName, SessionBaseHandler::class, true)) {
      throw new InvalidArgumentException(
        sprintf('Invalid session handler "%s" provided.', $driverName),
      );
    }
