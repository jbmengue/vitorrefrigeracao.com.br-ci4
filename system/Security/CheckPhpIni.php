...
class CheckPhpIni
{
  ...
  private static function outputForWeb(array $output, array $thead, array $tbody): string
  {
    foreach ($output as $directive => $values) {
      ...
      if ($values["recommended"] !== "") {
        ...
        $current = $notRecommended ? '<span style="color: red">' . $current . "</span>" : $current;
      }
  ...
  public static function checkIni(?string $argument = null): array
  {
    ...
    $items = [
      ...
      "opcache.enable_cli" => [
        "recommended" => "0",
        "remark" => "Enable when you are using queues or running repetitive CLI tasks",
      ],
      "opcache.jit" => ["recommended" => "tracing"],
      "opcache.jit_buffer_size" => [
        "recommended" => "128",
        "remark" => "Adjust with your free space of memory",
      ],
    ...
    if ($argument === "opcache") {
      $items = [
        ...
        "opcache.jit" => [
          "recommended" => "tracing",
          "remark" => "Disable when you used third-party extensions",
        ],
        "opcache.jit_buffer_size" => [
          "recommended" => "128",
          "remark" => "Adjust with your free space of memory",
        ...
        "opcache.max_accelerated_files" => [
          "remark" =>
            'Adjust based on the number of PHP files in your project (e.g.: find your_project/ -iname \'*.php\'|wc -l)',
        ],
        "opcache.max_wasted_percentage" => ["recommended" => "10"],
        "opcache.validate_timestamps" => [
          "recommended" => "0",
          "remark" =>
            "When you disabled, opcache hold your code into shared memory. Restart webserver needed",
        ],
        "opcache.revalidate_freq" => [],
        "opcache.file_cache" => [
          "remark" =>
            "Location file caching, It should improve performance when SHM memory is full",
        ],
        "opcache.file_cache_only" => [
          "remark" => "Opcode caching in shared memory, Disabled when you using Windows",
        ],
