...
class Forge extends BaseForge
{
  ...
  protected function _alterTable(string $alterType, string $table, $processedFields)
  {
    switch ($alterType) {
      case "CHANGE":
        ...
        (new Table($this->db, $this))->fromTable($table)->modifyColumn($fieldsToModify)->run();
  ...
  public function addForeignKey(
    ...
    throw new DatabaseException(
      "SQLite does not support foreign key names. CodeIgniter will refer to them in the format: prefix_table_column_referencecolumn_foreign",
    );
  }
