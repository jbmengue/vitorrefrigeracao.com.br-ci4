...
class AutoloadConfig
{
  ...
  protected $coreClassmap = [
    ...
    InvalidArgumentException::class =>
      SYSTEMPATH . "ThirdParty/PSR/Log/InvalidArgumentException.php",
    ...
    EscaperInvalidArgumentException::class =>
      SYSTEMPATH . "ThirdParty/Escaper/Exception/InvalidArgumentException.php",
